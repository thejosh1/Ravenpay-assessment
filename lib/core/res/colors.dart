...
class AppColors {
  ...
  static const Color avatarBackgroundColor = Color(0xFFF0A0A0);
  static const Color darkGrey = Color(0xFF20252B);
  ...
  static const borderColor = Color(0xFF373B3F);
  static const blue = Color(0xFF2764FF);
  static const popupBackground = Color(0xFF1C2127);
  static const menuBackground = Color(0xFF252A30);
